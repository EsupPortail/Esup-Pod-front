    ...
    <div>
      ...
      {isRedirecting ? (
        ...
        <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
          ...
          />
          {/* Message d’erreur du FileUploader */}
          {errors.videoFile && (
            <p
              id="videoFile-error"
          ...
          <fieldset className={styles.bloc_terms}>
            <legend>
              <b>
                Attention ! Respectez le code de la propriété intellectuelle
                avant de publier une vidéo :
              </b>
            </legend>
            <p>
              Je confirme que je dispose des autorisations nécessaires signées
              par les parties concernées par la publication de ce média, en
