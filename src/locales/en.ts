...
export const en: TranslationKeys = {
  ...
  webtv: {
    featured: "Featured",
    liveTitle: "Live Events",
    channelsAndThemes: "Our Channels & Themes",
  ...
  table: {
    ...
    noSourceBadge: "Empty entry (no source)",
  ...
  videoEdit: {
    ...
    tagsHelper: "Press Enter or separate with commas to add tags.",
