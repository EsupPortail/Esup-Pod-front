...
export const es: TranslationKeys = {
  ...
  webtv: {
    featured: "Destacados",
    liveTitle: "Eventos en directo",
    channelsAndThemes: "Nuestros Canales y Temas",
  ...
  table: {
    ...
    noSourceBadge: "Ficha vacía (sin fuente)",
  ...
  videoEdit: {
    ...
    tagsLabel: "Palabras clave / Etiquetas",
    tagsHelper: "Presione Entrar o separe con comas para añadir etiquetas.",
